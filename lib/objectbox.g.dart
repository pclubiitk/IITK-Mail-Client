...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 8929270144920268482),
      name: 'Email',
      lastPropertyId: const IdUid(7, 1213582523325080519),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 4900269546417049668),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 5142995408940464879),
            name: 'from',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 2238464475952836484),
            name: 'to',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 6895810574589621522),
            name: 'subject',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 5375157763557811923),
            name: 'body',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(6, 1238673027094755533),
            name: 'receivedDate',
            type: 10,
            flags: 0),
        ModelProperty(
            id: const IdUid(7, 1213582523325080519),
            name: 'uniqueId',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 8929270144920268482),
